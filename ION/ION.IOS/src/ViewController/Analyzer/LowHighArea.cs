...
namespace ION.IOS.ViewController.Analyzer
{
    ...
    public LowHighArea (UIView mainView, AnalyzerViewController ViewController)
		{
      lowArea = new lowHighSensor(new CGRect(.028 * mainView.Bounds.Width, .505 * mainView.Bounds.Height, .465 * mainView.Bounds.Width, .202 * mainView.Bounds.Height), new CGRect(.028 * mainView.Bounds.Width,.707 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.3 * mainView.Bounds.Height), ViewController);//, new CGRect(0,0,.859 * mainView.Bounds.Width,.044 * mainView.Bounds.Height), new CGRect(0,.0017 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.07 * mainView.Bounds.Height), new CGRect(0,.114 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.044 * mainView.Bounds.Height),new CGRect(0,.158 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.044 * mainView.Bounds.Height), new CGRect(.028 * mainView.Bounds.Width,.771 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.214 * mainView.Bounds.Height));
      highArea = new lowHighSensor (new CGRect (.507 * mainView.Bounds.Width, .505 * mainView.Bounds.Height, .465 * mainView.Bounds.Width, .202 * mainView.Bounds.Height), new CGRect(.507 * mainView.Bounds.Width,.707 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.3 * mainView.Bounds.Height), ViewController);//, new CGRect(0,0,.465 * mainView.Bounds.Width,.044 * mainView.Bounds.Height), new CGRect(0,.0017 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.07 * mainView.Bounds.Height), new CGRect(0,.114 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.044 * mainView.Bounds.Height), new CGRect(0,.158 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.044 * mainView.Bounds.Height), new CGRect(.515 * mainView.Bounds.Width,.771 * mainView.Bounds.Height,.465 * mainView.Bounds.Width,.214 * mainView.Bounds.Height));
		} 
