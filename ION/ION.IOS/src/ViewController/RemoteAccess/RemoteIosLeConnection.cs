namespace ION.IOS.ViewController.RemoteAccess {
  ...
  public class RemoteIosLeConnection : IConnection {
    /// <summary>
    ...
    /// </summary>
		private RemoteLeConnectionHelper connectionHelper { get; set; }
    /// <summary>
    ...
    /// <param name="peripheral">Peripheral.</param>
		public RemoteIosLeConnection(RemoteLeConnectionHelper connectionHelper, CBPeripheral peripheral) {
