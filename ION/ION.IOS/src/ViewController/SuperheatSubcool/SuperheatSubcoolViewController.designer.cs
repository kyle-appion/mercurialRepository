...
namespace ION.IOS.ViewController.SuperheatSubcool
{
	...
	partial class SuperheatSubcoolViewController
	{
		...
		[Outlet]
		UIKit.UILabel labelFluidDelta { get; set; }

		[Outlet]
		UIKit.UILabel labelFluidName { get; set; }

		[Outlet]
		UIKit.UILabel labelFluidState { get; set; }

		[Outlet]
		UIKit.UILabel labelPressure { get; set; }

		[Outlet]
		UIKit.UILabel labelSatTemp { get; set; }

		[Outlet]
		UIKit.UILabel labelSatTempMeasurement { get; set; }

		[Outlet]
		UIKit.UILabel labelSatTempUnit { get; set; }
		...
		[Outlet]
		UIKit.UIView viewDivider3 { get; set; }

		[Outlet]
		UIKit.UIView viewDivider4 { get; set; }
		...
		[Outlet]
		UIKit.UIView viewSatTempSection { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (labelSatTempMeasurement != null) {
				labelSatTempMeasurement.Dispose ();
				labelSatTempMeasurement = null;
			}
			...
			if (viewSatTempSection != null) {
				viewSatTempSection.Dispose ();
				viewSatTempSection = null;
			}
