...
{
	public class AccessAllowingTableSource : UITableViewSource
	{


		public AccessAllowingTableSource ()
		{
		}
		...
		public AccessAllowingTableSource (List<accessUserData> items,double cHeight){
			tableItems = items;
      ...
      return tableItems.Count;
		...
		public override UITableViewCell GetCell (UITableView tableView, Foundation.NSIndexPath indexPath)
		{
			...
			var cell = tableView.DequeueReusableCell("allowingCell") as AllowingUserCell;
			if (cell == null) {
