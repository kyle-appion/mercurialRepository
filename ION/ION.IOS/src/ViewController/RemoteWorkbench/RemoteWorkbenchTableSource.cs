namespace ION.IOS.ViewController.RemoteAccess {
	...
	/// </summary>
	public class RemoteWorkbenchTableSource : UITableViewSource, IReleasable {
    ...
    /// </summary>
    /// <value>The vc.</value>
    private RemoteWorkbenchViewController vc { get; set; }
    /// <summary>
    ...
    public RemoteWorkbenchTableSource(RemoteWorkbenchViewController vc, IION ion, UITableView tableView) {
      this.vc = vc;
      this.ion = ion;
