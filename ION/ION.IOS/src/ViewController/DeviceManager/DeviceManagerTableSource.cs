namespace ION.IOS.ViewController.DeviceManager {
  ...
  public class DeviceManagerTableSource : UITableViewSource, IReleasable {
    /// <summary>
    ...
    /// </summary>
    /// <value>The vc.</value>
    internal DeviceManagerViewController vc { get; private set; }
    /// <summary>
    /// The table view that the source belongs to.
    /// </summary>
    internal UITableView tableView { get; private set; }

    public DeviceManagerTableSource(IION ion, DeviceManagerViewController vc, UITableView tableView) {
      this.ion = ion;
      this.vc = vc;
