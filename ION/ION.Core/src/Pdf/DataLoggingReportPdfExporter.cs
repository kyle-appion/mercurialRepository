...
namespace ION.Core.Pdf {
  ...
  public class DataLoggingReportPdfExporter {
    /// <summary>
    /// Commits the pdf to a stream.
    /// </summary>
    /// <param name="outstream">Outstream.</param>
    public static void Export(DataLoggingReport report, Stream outstream) {
    ...
    /// </summary>
    private static void DrawHeader(DataLoggingReport report, PdfPage page, PdfStandardRectangle bounds, PdfStandardFont title, PdfStandardFont subtitle) {
    ...
    private static void DrawScreenshot(DataLoggingReport report, PdfPage page, PdfStandardRectangle bounds) {
      var l = bounds.LLX;
      var t = bounds.LLY;
    ...
    /// <param name="page">Page.</param>
    /// <param name="bounds">Bounds.</param>
    private static void DrawContent(DataLoggingReport report, PdfPage page, PdfStandardRectangle bounds, PdfStandardFont header, PdfStandardFont content) {
      var g = page.Graphics;
