namespace ION.Droid.Fragments._Analyzer {
	...
	public class SimpleSensorPropertyRecord : SensorPropertyRecord<ISensorProperty> {
		public SimpleSensorPropertyRecord(Manifold manifold, ISensorProperty sp) : base(manifold, sp, SubviewAdapter.EViewType.Simple) { 
		}
	}
	...
	public class SimpleSensorPropertyViewHolder : SensorPropertyViewHolder<ISensorProperty> {
		...
		public SimpleSensorPropertyViewHolder(SwipeRecyclerView recyclerView, BitmapCache cache) : base(recyclerView, Resource.Layout.subview_measurement_small) {
			this.cache = cache;
