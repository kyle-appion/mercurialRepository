namespace ION.Droid.Fragments._Analyzer {
	...
	public class SecondarySensorPropertyRecord : SensorPropertyRecord<SecondarySensorProperty> {
		public SecondarySensorPropertyRecord(Manifold manifold, SecondarySensorProperty sp) : base(manifold, sp, SubviewAdapter.EViewType.Secondary){ 
		}
	}
	...
	public class SecondarySensorPropertyViewHolder : SensorPropertyViewHolder<SecondarySensorProperty> {
		...
		public SecondarySensorPropertyViewHolder(SwipeRecyclerView recyclerView) : base(recyclerView, Resource.Layout.subview_measurement_small) {
