namespace ION.Droid.Fragments._Analyzer {
	...
	public class PTSensorPropertyRecord : SensorPropertyRecord<PTChartSensorProperty> {
		public PTSensorPropertyRecord(Manifold manifold, PTChartSensorProperty sp) : base(manifold, sp, SubviewAdapter.EViewType.PT) { 
		}
	}
	...
	public class PTSensorPropertyViewHolder : SensorPropertyViewHolder<PTChartSensorProperty> {
		...
		public PTSensorPropertyViewHolder(SwipeRecyclerView parent) : base(parent, Resource.Layout.subview_fluid_small) {
